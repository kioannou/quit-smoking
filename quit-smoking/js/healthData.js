(function () {
    ...
    var healthArray = [
        { type: "item", value: 1, seed: "", after: "After 1 day", text: "Less than 20 minutes after your last cigarette, your heart rate will already start to drop towards normal levels. Your peripheral circulation improves. The carbon monoxide in your blood drops to normal." },
        { type: "item", value: 3, seed: "", after: "After 3 days", text: "Your entire body is 100% nicotine-free. Symptoms of chemical withdrawal have peaked in intensity. Breathing is becoming easier and your lung's functional abilities are increasing." },
